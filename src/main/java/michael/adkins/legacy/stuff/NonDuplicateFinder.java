...
public class NonDuplicateFinder {
    ...
    public static int findSingleInteger(List<Integer> nums) {
        ...
        nums.forEach(integer -> ocurrences.put(integer, ocurrences.getOrDefault(integer, 0) + 1));
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Single integer in %s is %d.%n", nums, findSingleInteger(nums));
        System.out.printf("Single integer in %s is %d.", nums, findSingleInteger1(nums));
    }
}
